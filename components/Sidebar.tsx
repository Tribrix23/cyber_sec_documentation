...
const navSections: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    title: 'WIRESHARK',
    items: [
      { label: 'Capture Filters', path: '/capture-filters', icon: 'ri-filter-3-line' },
      { label: 'Display Filters', path: '/display-filters', icon: 'ri-search-line' },
      { label: 'Filter Builder', path: '/filter-builder', icon: 'ri-tools-line' },
      { label: 'Protocol Analysis', path: '/protocol-analysis', icon: 'ri-exchange-line' },
      { label: 'Advanced Features', path: '/advanced-features', icon: 'ri-bar-chart-grouped-line' },
      { label: 'Command Line', path: '/command-line', icon: 'ri-terminal-line' },
      { label: 'Troubleshooting', path: '/troubleshooting', icon: 'ri-bug-line' },
      { label: 'Wireshark Quiz', path: '/wireshark-quiz', icon: 'ri-questionnaire-line' },
      { label: 'Wireshark Lab', path: '/wireshark-lab', icon: 'ri-flask-line' },
    ],
  },
  {
    title: 'NMAP',
