      ...
      <div className="px-6 md:px-12 lg:px-16 py-10 max-w-5xl">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ duration: 0.5 }}>
          ...
          <p className="text-cyber-text leading-relaxed mt-3 text-lg">
                         The <strong className="text-cyber-cyan">s3</strong> mode brute forces Amazon S3 bucket names to find publicly exposed buckets with misconfigured permissions. S3 buckets are a common source of data breaches when left open or misconfigured.
          </p>
        </motion.div>
        ...
        <motion.section className="mt-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          ...
          <p className="text-cyber-text leading-relaxed mt-3">
                         Amazon S3 (Simple Storage Service) is a cloud object storage service. Files are stored in containers called <strong className="text-cyber-cyan">buckets</strong>, each with a globally unique name. Bucket names follow the pattern: <InlineCode>https://bucket-name.s3.amazonaws.com/</InlineCode>.
          </p>
          <p className="text-cyber-text leading-relaxed mt-3">
        ...
        <motion.section className="mt-12" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <p className="text-xs text-cyber-text mt-2">Tests each word in the wordlist as a potential S3 bucket name against AWS endpoints.</p>
            </div>
            <div>
              ...
              <p className="text-xs text-cyber-text mt-2">Increases thread count for faster enumeration against AWS APIs.</p>
            </div>
            <div>
              ...
              <p className="text-xs text-cyber-text mt-2">Saves discovered bucket names for manual inspection and reporting.</p>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section className="mt-12 mb-16" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          ...
          <div className="mt-4 space-y-3">
           ...
           <div className="mt-8 flex gap-3">
              <a href="/gobuster/fuzz" className="px-5 py-2.5 rounded-lg bg-cyber-amber text-black text-sm font-semibold hover:bg-cyber-amber/80 transition-all whitespace-nowrap">
               Next: Fuzzing <i className="ri-arrow-right-line ml-1" />
             </a>
             <a href="/gobuster/vhost" className="px-5 py-2.5 rounded-lg border border-cyber-border text-sm font-semibold text-cyber-text hover:border-cyber-amber hover:text-cyber-amber transition-all whitespace-nowrap">
